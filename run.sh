...
# default
python main_detect.py -m default > ./tmp_log/default.txt
...
# check dis
python main_detect.py -m dis1 --dis 1 > ./tmp/dis1.txt
python main_detect.py -m dis5 --dis 5 > ./tmp/dis5.txt

## lr
python main_detect.py -m lr1 --lr 0.0001 > ./tmp/lr1.txt
python main_detect.py -m lr2 --lr 0.001 > ./tmp/lr2.txt
python main_detect.py -m lr3 --lr 0.01 > ./tmp/lr3.txt
