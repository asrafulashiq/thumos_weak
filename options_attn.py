...
parser.add_argument('--feature-size', default=2048, type=int, help='size of feature (default: 2048)')
...
parser.add_argument('--num-similar', default=0, type=int, help='number of similar pairs in a batch of data  (default: 3)')
...
parser.add_argument('--valid', action='store_false', help='validation')
