...
parser.add_argument('--model-name', default='attn', help='name to save model')
parser.add_argument('--pretrained-ckpt', default='./ckpt/attn.pkl', help='ckpt for pretrained model')
