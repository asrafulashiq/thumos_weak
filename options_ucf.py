...
parser.add_argument('--model-name', '-m', default='ucf', help='name to save model')
...
parser.add_argument('--num-class', default=5, type=int, help='number of classes (default: )')
parser.add_argument('--dataset-name', type=str, default='UCF_Crime', help='dataset to train on (default: )')
parser.add_argument('--max-seqlen', type=int, default=100, help='maximum sequence length during training (default: 750)')
parser.add_argument('--Lambda', default=0.0001, type=float, help='weight on Co-Activity Loss (default: 0.5)')
